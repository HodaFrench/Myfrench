// ═══════════════════════════════════════════════════════════
//  پرونده‌ی کاوه محمدی — اپلیکیشن تعاملی
...
function showDashboard() {
  ...
  dash.innerHTML = `
    <div class="intro fade-in">
      سلام کاوه 👋 این پرونده از روی کارِ خودت ساخته شده. ایده‌اش: <b>به‌جای حفظ‌کردن جواب‌ها</b>، با فکر فارسیِ خودت روان‌تر حرف بزنی. از فهرست زیر هر بخشی را که می‌خواهی انتخاب کن — همه‌چیز منظم و جداست تا تمرکزت حفظ شود. 🎯
    </div>
