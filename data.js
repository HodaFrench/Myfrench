...
const LESSONS = [
  ...
  },
  {
    ...
    tags: ["passé composé","auxiliaire","participe passé"],
    summary: "گذشته مرکب کامل"
  },
  {
    ...
    tags: ["prononciation","vidéo","phonétique"],
    summary: "۵ ویدیو تمرین تلفظ"
  },
  {file:"PRON_jour1.html",title:"🔊 روز ۱ — Les sifflantes",titleFr:"Sifflantes",category:"prononciation",level:"A1–B2",tags:["prononciation"],summary:"S Z CH J"},
  {file:"PRON_jour2.html",title:"🔊 روز ۲ — Le R français",titleFr:"Le R",category:"prononciation",level:"A1–B2",tags:["prononciation"],summary:"R گلویی"},
  {file:"PRON_jour3.html",title:"🔊 روز ۳ — Les nasales",titleFr:"Nasales",category:"prononciation",level:"A1–B2",tags:["prononciation"],summary:"AN ON IN"},
  {file:"PRON_jour4.html",title:"🔊 روز ۴ — Liaison",titleFr:"Liaison",category:"prononciation",level:"A1–B2",tags:["prononciation"],summary:"S muet liaison"},
  {file:"PRON_jour5.html",title:"🔊 روز ۵ — ON vs AN",titleFr:"ON vs AN",category:"prononciation",level:"A1–B2",tags:["prononciation"],summary:"ON AN R final"},
  ...
  },
  {
    ...
    category: "vocab",
    sub: "mots_aujourdhui", level: "B1–B2",
  ...
  {
    file: "VOCAB_notes_evaluation.html",
    title: "📚 Les notes & l'évaluation",
    titleFr: "Les notes & l'évaluation à l'école",
    category: "vocab",
    sub: "thematique", level: "B2–C1",
...
const INNERFRENCH = [
  ...
  {
    num: 8,
    titre: "Les stéréotypes sur les Français",
    titreFa: "کلیشه‌های فرانسوی‌ها",
    theme: "جامعه · فرهنگ",
    audio: "https://mcdn.podbean.com/mf/web/6v4bea/08_LCP008_-_The_Truth_about_French_People.mp3",
    source: "https://innerfrench.com/08-stereotypes-francais-verite/",
    intro: "هوگو درباره‌ی کلیشه‌های فرانسوی‌ها صحبت می‌کند: غذا، ظاهر، شخصیت — کدام درست‌اند و کدام افسانه؟",
    paras: [],
  },
  {
    num: 9,
    titre: "La décroissance",
    titreFa: "کاهش رشد اقتصادی",
    theme: "اقتصاد · محیط زیست",
    audio: "https://mcdn.podbean.com/mf/web/njq56w/09_LCP009_-_Time_for_Degrowth_.mp3",
    source: "https://innerfrench.com/09-decroissance/",
    intro: "آیا می‌توان بدون رشد اقتصادی دائمی زندگی کرد؟ هوگو درباره‌ی نظریه‌ی décroissance حرف می‌زند.",
    paras: [],
  },
  {
    num: 10,
    titre: "Le fast fashion",
    titreFa: "مد سریع",
    theme: "محیط زیست · جامعه · آزمایش میلگرم",
    audio: "https://mcdn.podbean.com/mf/web/hibe6z/10_LCP010_-_Milgram_s_Experiment.mp3",
    source: "https://innerfrench.com/10-experience-milgram/",
    intro: "تأثیرات زیست‌محیطی و اجتماعی صنعت پوشاک سریع، و ارتباطش با آزمایش معروف میلگرم.",
    paras: [],
  },
  {
    num: 11,
    titre: "La solitude",
    titreFa: "تنهایی",
    theme: "روانشناسی · جامعه",
    audio: "https://mcdn.podbean.com/mf/web/ivwx8b/11_LCP011_-_Should_you_turn_into_an_Early_Bird_.mp3",
    source: "https://innerfrench.com/11-lever-tot/",
    intro: "تنهایی در جامعه‌ی مدرن و بحث درباره‌ی زود بیدار شدن — آیا باید سحرخیز شوی؟",
    paras: [],
  },
  {
    num: 12,
    titre: "Le sport et la santé",
    titreFa: "ورزش و سلامت",
    theme: "سلامت · ورزش · ۱۴ ژوئیه",
    audio: "https://mcdn.podbean.com/mf/web/tkufid/12_LCP012_-_Bastille_Day.mp3",
    source: "https://innerfrench.com/12-14-juillet-france/",
    intro: "فواید ورزش برای سلامت جسم و روح، و جشن ملی فرانسه (۱۴ ژوئیه).",
    paras: [],
  },
];
